...
const CategoryPage = () => {
  ...
  const imagesData = [
    ...
    { id: 31, title: 'Animal 1', category: 'Animal', src: '/Animal1.jpg' },
    { id: 32, title: 'Animal 2', category: 'Animal', src: '/Animal2.jpg' },
    { id: 33, title: 'Animal 3', category: 'Animal', src: '/Animal3.jpg' },
    { id: 34, title: 'Animal 3', category: 'Animal', src: '/Animal4.jpg' },
    { id: 35, title: 'Animal 3', category: 'Animal', src: '/Animal5.jpg' },
    { id: 36, title: 'Animal 3', category: 'Animal', src: '/Animal6.jpg' },
    { id: 37, title: 'Animal 3', category: 'Animal', src: '/Animal7.jpg' },
    { id: 38, title: 'Animal 3', category: 'Animal', src: '/Animal8.jpg' },
    { id: 39, title: 'Animal 3', category: 'Animal', src: '/Animal9.jpg' },
    { id: 40, title: 'Animal 3', category: 'Animal', src: '/Animal10.jpg' },
    { id: 41, title: 'Animal 3', category: 'Animal', src: '/Animal11.jpg' },
    { id: 42, title: 'Animal 3', category: 'Animal', src: '/Animal12.jpg' },
    { id: 43, title: 'Animal 3', category: 'Animal', src: '/Animal13.jpg' },
    { id: 44, title: 'Animal 3', category: 'Animal', src: '/Animal14.jpg' },
    { id: 45, title: 'Animal 3', category: 'Animal', src: '/Animal15.jpg' },
  ];
